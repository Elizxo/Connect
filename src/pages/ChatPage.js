...
const ChatInterface = () => {
    ...
    const handleSendMessage = () => {
        if (inputValue.trim()) {
            ...
            // Simulate typing indicator for received messages
            setIsTyping(true);
            setTimeout(() => {
                setIsTyping(false);
                // Auto-reply after 2 seconds (optional)
                setTimeout(() => {
                    const autoReply = {
                        id: Date.now() + 1,
    ...
    return (
        <div className="chat-container">
            <div className="chat-header">
                <div className="avatar">Profile</div> //image porfile
                ...
                {messages.map((message) => (
                    ...
                    >
                        ...
                        {message.read && message.sent && (
                            <div className="read-indicator">Read</div>
                        )}
                    </div>
                ))}
